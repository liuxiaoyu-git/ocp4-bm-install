...
\cp /etc/named.rfc1912.zones.origin /etc/named.rfc1912.zones > /dev/null 2>&1 || \cp /etc/named.rfc1912.zones /etc/named.rfc1912.zones.origin
\cp /etc/named.conf.origin /etc/named.conf > /dev/null 2>&1 || \cp /etc/named.conf /etc/named.conf.origin
