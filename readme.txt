*********************************************************************************************
* 请在完成《OCP4 在线裸机UPI部署手册-workshop》的“4.1上传安装介质”后再执行Shell，以加速安装操作  *
*********************************************************************************************
...
source ./7-ntp.sh
source ./8-haproxy.sh
source ./10-ignition-file.sh
source ./11-autoconfig-file.sh
source ./12-ready-for-install.sh

*********************************************************************************************
* 成功执行完全部Shell后，可继续参照《OCP4 在线裸机UPI部署手册-workshop》                        *
